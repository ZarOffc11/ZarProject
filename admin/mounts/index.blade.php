        ...
        <div class="theme-card">
            ...
            <div class="card-header-unified">
                <div class="header-title">
                    <h1>Mounts</h1>
                    <small>Manage additional mount points for servers.</small>
                </div>
                <div>
                    <button class="btn-simple" data-toggle="modal" data-target="#newMountModal">
        ...
        <div class="modal-content">
            <form action="{{ route('admin.mounts') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="pName" name="name" class="form-control" placeholder="e.g. Local Storage" />
                                <p class="text-muted small">Unique identifier for this mount.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="pDescription" name="description" class="form-control" rows="4" placeholder="Optional description..."></textarea>
                                <p class="text-muted small">Must be less than 191 characters.</p>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="pSource" class="form-label">Source Path</label>
                                <input type="text" id="pSource" name="source" class="form-control" placeholder="/mnt/source" />
                                <p class="text-muted small">File path on the host system.</p>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="pTarget" class="form-label">Target Path</label>
                                <input type="text" id="pTarget" name="target" class="form-control" placeholder="/mnt/target" />
                                <p class="text-muted small">Path inside the container.</p>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-group">
                                    <label class="radio-label" for="pReadOnlyFalse">
                                        <input type="radio" id="pReadOnlyFalse" name="read_only" value="0" checked> False
                                    </label>
                                    <label class="radio-label" for="pReadOnly">
                                        <input type="radio" id="pReadOnly" name="read_only" value="1"> True
                                    </label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-group">
                                    <label class="radio-label" for="pUserMountableFalse">
                                        <input type="radio" id="pUserMountableFalse" name="user_mountable" value="0" checked> False
                                    </label>
                                    <label class="radio-label" for="pUserMountable">
                                        <input type="radio" id="pUserMountable" name="user_mountable" value="1"> True
                                    </label>
                                </div>
                                <p class="text-muted small">Can users mount this themselves?</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn-primary-theme">Create Mount</button>
                </div>
            </form>
        </div>
    </div>
